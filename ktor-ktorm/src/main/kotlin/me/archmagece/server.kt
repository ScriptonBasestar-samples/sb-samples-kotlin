...
fun initDB(baseConfig: Config): Database {
    ConfigFactory.load().withFallback(baseConfig).run {
...
fun Application.module() {
    ...
    val commonService = CommonHandler(database)
    val boardService = BoardHandler(database)
